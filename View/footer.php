...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span><strong>Copyright &copy; 2020 iDrCrop,</strong></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" style="font-weight:700">¿Esta seguro(a) que desea cerrar sesión?</h5>
...
<script src="../public/datepicker/clockpicker.js"></script>
...
<script src="../js/animodo.js"></script>
<script src="../js/generacional.js"></script>
<script src="../js/comunicacion.js"></script>
<script src="../js/testVak.js"></script>
<script src="../js/tiposCerebro.js"></script>
<script src="../js/negociadora.js"></script>
<script src="../js/persistencia.js"></script>
<script src="../js/inidividual.js"></script>
