<title>Cambio Generacional | iDrCrop.</title>
            ...
            <div class="card shadow mb-4 ">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between ">
                    <h3 class="m-0 font-weight-bold text-primary">
                        ...
                        Estadisticas Cambio Generacional
                    </h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-2 mb-4">
                        <div class="col-lg-4">
                            ...
                            <select name="searchParam" id="searchParam" class="form-control" onchange="cambio(this.value)">
